...
public class ResolutionSetting : Setting
{
    ...
    {
        return avalibaleResolution[currentResolutionIndex].x + "x" + 
            avalibaleResolution[currentResolutionIndex].y;
    }

    public override void Apply()
    {
        Screen.SetResolution(avalibaleResolution[currentResolutionIndex].x, 
            avalibaleResolution[currentResolutionIndex].y, true);
